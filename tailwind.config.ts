  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        theme: {
          darkBlack: "rgb(0, 0, 0)", // Changed from darkPurple to darkBlack
          deepBlue: "rgb(2, 16, 118)",
          magenta: "rgb(179, 16, 153)",
          pink: "rgb(255, 16, 173)",
          red: "rgb(209, 16, 52)",
        },
      },
      ...
      keyframes: {
        ...
        glow: {
          "0%, 100%": { boxShadow: "0 0 5px rgba(179, 16, 153, 0.5)" },
          "50%": { boxShadow: "0 0 20px rgba(179, 16, 153, 0.8)" },
        },
        "gradient-x": {
